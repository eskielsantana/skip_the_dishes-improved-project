...
public class MainController {
    ...
    public ResponseEntity<String> requestOrder(@RequestHeader String token, @RequestBody OrderRestDto orderRestDto) {
        ...
        Integer customerId = customerBusinessLogicService.validateToken(token);
        orderRestDto.setCustomerId(customerId);
    ...
    public ResponseEntity<String> cancelOrder(@RequestHeader String token, @RequestHeader Integer orderId) {
